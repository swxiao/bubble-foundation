 ...
 */
@NoRepositoryBean
public interface MybatisRepository<T extends AbstractEntity, ID extends Serializable> extends Repository<T, ID> {
	...
	/**
	 * Update given entity,return update data by query.
	 * 
	 * @param entity
	 */
	T update(T entity, boolean query);

	/**
	 * save given entity if exist update it.
	 * 
	 * @param entity
	 * @return save or update data
	 */
